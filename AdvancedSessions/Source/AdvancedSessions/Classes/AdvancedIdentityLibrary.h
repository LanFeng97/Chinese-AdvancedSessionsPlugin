...
public:
	...
	// 获取本地玩家的登录状态
	UFUNCTION(BlueprintCallable, Category = "Online|AdvancedIdentity", meta = (DisplayName = "获取登录状态 (GetLoginStatus)", ExpandEnumAsExecs = "Result", WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintCallable, Category = "Online|AdvancedIdentity", meta = (DisplayName = "获取玩家身份验证令牌 (GetPlayerAuthToken)", ExpandEnumAsExecs = "Result", WorldContext = "WorldContextObject"))
	...
	// 获取玩家的昵称
	UFUNCTION(BlueprintPure, Category = "Online|AdvancedIdentity", meta = (DisplayName = "获取玩家昵称 (GetPlayerNickname)", WorldContext = "WorldContextObject"))
	...
	// Get a users account
	// 获取用户账号
	UFUNCTION(BlueprintCallable, Category = "Online|AdvancedIdentity|UserAccount", meta = (DisplayName = "获取用户账号 (GetUserAccount)", ExpandEnumAsExecs = "Result", WorldContext = "WorldContextObject"))
	...
	// 获取所有已知的用户账号
	UFUNCTION(BlueprintCallable, Category = "Online|AdvancedIdentity|UserAccount", meta = (DisplayName = "获取所有用户账号 (GetAllUserAccounts)", ExpandEnumAsExecs = "Result", WorldContext = "WorldContextObject"))
